...
const AdminDashboards = () => {
    ...
    const fetchData = async (date) => {
        const formattedDate = dayjs(date).format("MMM_DD_YYYY").toLowerCase();
        const url = `https://l3rs61583k.execute-api.us-east-2.amazonaws.com/dashboard/daily/${formattedDate}`;
