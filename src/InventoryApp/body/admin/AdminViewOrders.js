  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        let apiUrl = "https://m8wxr06qij.execute-api.us-east-1.amazonaws.com/dev/orders";

        if (filterCriteria === 'day' && filterValue) {
          apiUrl = `https://m8wxr06qij.execute-api.us-east-1.amazonaws.com/dev/orders/daily/${filterValue}`;
        } else if (filterCriteria === 'month' && filterValue) {
          apiUrl = `https://m8wxr06qij.execute-api.us-east-1.amazonaws.com/dev/orders/monthly/${filterValue}`;
        } else if (filterCriteria === 'year' && filterValue) {
          apiUrl = `https://m8wxr06qij.execute-api.us-east-1.amazonaws.com/dev/orders/yearly/${filterValue}`;
        }
